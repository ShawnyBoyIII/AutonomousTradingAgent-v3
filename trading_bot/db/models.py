...
class Trade(Base):
    ...
    strategy_tag = Column(String(200), nullable=True)
    swarm_sentiment_bucket = Column(String(20), nullable=True)
    signal_quality = Column(String(20), nullable=True)
    market_regime = Column(String(40), nullable=True)
    supermodel_decision = Column(String(20), nullable=True)
    swarm_decision = Column(String(30), nullable=True)
    consensus = Column(String(20), nullable=True)
    swarm_sentiment_score = Column(Float, nullable=True)
    swarm_sentiment_confidence = Column(Float, nullable=True)
    entry_volume_ratio = Column(Float, nullable=True)
    entry_range_ratio = Column(Float, nullable=True)
    adaptive_rr = Column(Float, nullable=True)
    ...
    exit_rsi = Column(Float, nullable=True)
    exit_atr = Column(Float, nullable=True)
    hold_duration_minutes = Column(Float, nullable=True)
...
class ScanFeature(Base):
    ...
    market_age_minutes = Column(Integer, nullable=True)
    market_regime = Column(String(40), nullable=True)
    strategy_tag = Column(String(200), nullable=True)
    consensus = Column(String(20), nullable=True)
    v3_total_score = Column(Float, nullable=True)
    supermodel_score = Column(Float, nullable=True)
    swarm_confidence = Column(Float, nullable=True)
    swarm_sentiment_score = Column(Float, nullable=True)
    swarm_sentiment_confidence = Column(Float, nullable=True)
    mtf_aligned = Column(Integer, nullable=True)
    entry_volume_ratio = Column(Float, nullable=True)
    entry_range_ratio = Column(Float, nullable=True)
    adaptive_rr = Column(Float, nullable=True)
